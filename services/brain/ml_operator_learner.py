    ...
    def _load_profile(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "fast_path_lexicon": {
                ...
                "open systems snapchat": {"tool": "launch_app", "args": {"app": "snapchat", "mode": "system"}, "hits": 5},
                "open system snapchat": {"tool": "launch_app", "args": {"app": "snapchat", "mode": "system"}, "hits": 5},
                "open snapchat system": {"tool": "launch_app", "args": {"app": "snapchat", "mode": "system"}, "hits": 5},
                "open snapchat": {"tool": "launch_app", "args": {"app": "snapchat", "mode": "web"}, "hits": 5},
                "launch snapchat": {"tool": "launch_app", "args": {"app": "snapchat", "mode": "web"}, "hits": 5},
